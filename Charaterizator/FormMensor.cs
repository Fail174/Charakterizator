...
namespace Charaterizator
{
    public partial class FormMensor : Form        
    {
        ...
        //--------------------------------------------------------------------------------
        // ФУНКЦИЯ - Идентификации Менсора
        // Задает канал активным канал B
        // Устанавливает AutoRange
        // Проверяет если комманды выполнились, возвращает 1
        // в проотивном случае 0 , или -1 при сбое
        int mensorID()
        {
            string str = "";
            int res = -1;
